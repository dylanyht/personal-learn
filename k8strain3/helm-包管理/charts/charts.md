# Charts[¶](https://www.qikqiak.com/k3s/helm/charts/#Charts)
...
#### alias 字段[¶](https://www.qikqiak.com/k3s/helm/charts/#alias-字段)
...
#### 作用范围、依赖和 Values[¶](https://www.qikqiak.com/k3s/helm/charts/#作用范围依赖和-Values)
